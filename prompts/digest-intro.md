...
4. 📱 REDDIT section — list top posts from AI subreddits
5. 🎬 YOUTUBE section — list trending AI/tech videos
...
Score: X | Comments: Y
Summary in Chinese (max 60 words).

🔗 URL
```
- Use emoji like 💬 for discussion posts, 🔥 for hot topics
- Keep summaries concise — focus on the key insight or debate
- Include the permalink URL

### YouTube video formatting
```
**Channel Name: Video Title**
Brief summary in Chinese (max 50 words).

🔗 YouTube URL
```
- Include the channel name and video title
- Focus on what makes this video noteworthy
- Include the direct video URL
...
- Reddit: the post permalink (e.g. https://reddit.com/r/.../...)
- YouTube: the video URL (e.g. https://www.youtube.com/watch?v=...)
...
### Section Dividers
Use these dividers between sections:
```
────────────────
